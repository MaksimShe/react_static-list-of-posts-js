...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>U.jsxs("div",{className:"CommentInfo",children:[U.jsxs("div",{className:"CommentInfo__title",children:[U.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",U.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),U.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>U.jsx("div",{className:"CommentList",children:e.map(t=>U.jsx(Pc,{comment:t}))}),Tc=({user:e})=>U.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>{const{title:t,body:i,user:n,comments:a}=e;return U.jsxs("div",{className:"PostInfo",children:[U.jsxs("div",{className:"PostInfo__header",children:[U.jsx("h3",{className:"PostInfo__title",children:t}),U.jsxs("p",{children:[" Posted by  ",U.jsx(Tc,{user:n})]})]}),U.jsx("p",{className:"PostInfo__body",children:i}),U.jsx("hr",{}),!a||a.length===0?U.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):U.jsx(Lc,{comments:a})]})},Rc=({posts:e})=>e.map(t=>U.jsx(Mc,{post:t},t.id)),Dc=()=>{const e=Cc.map(t=>({...t,user:Nc.find(i=>t.userId===i.id),comments:zc.filter(i=>t.id===i.postId)||null}));return U.jsxs("section",{className:"App",children:[U.jsx("h1",{className:"App__title",children:"Static list of posts"}),U.jsx(Rc,{posts:e})]})};em(document.getElementById("root")).render(U.jsx(Dc,{}));
